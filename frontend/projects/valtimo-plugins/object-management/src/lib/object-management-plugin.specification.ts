...
const objectManagementPluginSpecification: PluginSpecification = {
  ...
  pluginTranslations: {
    nl: {
      ...
      objectManagementConfigurationId: 'ObjectManagement configuratie Id',
      objectManagementConfigurationIdTooltip: 'De ID van het geconfigureerde ObjectManagement',
    ...
    en: {
      ...
      objectManagementConfigurationId: 'ObjectManagement Configuration Id',
